...
define('TEXT_ACCOUNT_CREATED', 'Vielen Dank! Ihr neues Partner Konto wurde erfolgreich er&ouml;ffnet!<br><br>Eine Best&auml;tigung &uuml;ber Ihr neues Konto wird Ihnen zugesendet. Falls Sie dieses eMail nicht innerhalb einer Stunde erhalten, <a href="' . escs_href_link(FILENAME_AFFILIATE_CONTACT) . '">kontaktieren Sie uns</a> bitte.<br><br>Wenn Sie Fragen haben, <a href="' . escs_href_link(FILENAME_AFFILIATE_CONTACT) . '">kontaktieren Sie uns</a> bitte.');
?>