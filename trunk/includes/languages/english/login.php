...
define('HEADING_NEW_CUSTOMER', 'Click Continue If You Have Not Shopped With Us Previously');
define('TEXT_NEW_CUSTOMER', '');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Please click continue to create an account so that you can finish your purchase.  Thank you.');
